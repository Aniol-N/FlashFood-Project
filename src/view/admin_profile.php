...
<body>
    ...
    <!-- MODAL PARA LA CREACION DE UN event: -->
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form id="eventForm" action="../controller/XController.php" method="POST">
                ...
                <label for="eventName">name del Concierto:</label>
                <input type="text" id="eventName" name="eventName" required>

                <label for="eventType">Tipo de evento:</label>
                <input type="text" id="eventType" name="eventType" required>

                <label for="eventLocation">location del evento:</label>
    ...
    <!-- MODAL PARA LA ACTUALIZACIÓN DE UN event: -->
    ...
    <!-- MODAL PARA LA ELIMINACIÓN DE UN event: -->
