...
class AdminController
{
    ...
    public function create(): void
    {
        ...
        $stmt = $this->conn->prepare("SELECT COUNT(*) AS count FROM events WHERE name = :eventName");
        ...
        $stmt = $this->conn->prepare("INSERT INTO events (name, location, type) VALUES (:eventName, :eventLocation, :eventType)");
        $stmt->bindParam(':eventName', $eventName, PDO::PARAM_STR);
    ...
    public function update(): void
    {
        ...
        $stmt = $this->conn->prepare("SELECT COUNT(*) AS count FROM events WHERE nombre = :newEventName");
    ...
    public function delete(): void
    {
        ...
        try {
            $stmt = $this->conn->prepare("DELETE FROM Evento WHERE name=:eventName");
            $stmt->bindParam(':eventName', $eventName, PDO::PARAM_STR);
            $stmt->execute();
