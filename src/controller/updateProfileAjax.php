...
function updateCredentials()
{
    ...
    $conn = $db->getConnection();
       ...
       $stmt = $conn->prepare("SELECT COUNT(*) AS count FROM users WHERE email = :new_email AND email != :old_username");
    ...
    try {
        $stmt = $conn->prepare("UPDATE users SET email=:new_username, password=:new_password WHERE email=:old_username");
